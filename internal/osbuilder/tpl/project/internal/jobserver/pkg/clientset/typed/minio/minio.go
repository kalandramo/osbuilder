...
// Interface defines the interface for interacting with a MinIO client.
...
// NewForConfig initializes a new MinioClient
func NewForConfig(endpoint, accessKey, secretKey, bucketName string) (*MinioClient, error) {
