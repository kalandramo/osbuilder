...
type Interface interface {
	CreateTask(ctx context.Context, dataPath, trainingDataPath string) (string, error)
...
// NewForConfig initializes a new TrainManager
func NewForConfig() *TrainManager {
	return &TrainManager{
...
func (tm *TrainManager) processTask(taskID string) {
	...
	time.Sleep(10 * time.Second) // Uncomment if you want to simulate delay
