...
func (h *Handler) Create{{.Web.R.SingularName}}(ctx context.Context, rq *{{.M.APIAlias}}.Create{{.Web.R.SingularName}}Request) (*{{.M.APIAlias}}.Create{{.Web.R.SingularName}}Response, error) {
	{{- if .Web.WithOTel}}
...
func (h *Handler) Update{{.Web.R.SingularName}}(ctx context.Context, rq *{{.M.APIAlias}}.Update{{.Web.R.SingularName}}Request) (*{{.M.APIAlias}}.Update{{.Web.R.SingularName}}Response, error) {
...
func (h *Handler) Delete{{.Web.R.SingularName}}(ctx context.Context, rq *{{.M.APIAlias}}.Delete{{.Web.R.SingularName}}Request) (*{{.M.APIAlias}}.Delete{{.Web.R.SingularName}}Response, error) {
	return h.biz.{{.Web.R.BusinessFactoryName}}().Delete(ctx, rq)
}

// Delete{{.Web.R.PluralName}} deletes one or more {{.Web.R.PluralName}}.
func (h *Handler) Delete{{.Web.R.PluralName}}(ctx context.Context, rq *{{.M.APIAlias}}.Delete{{.Web.R.PluralName}}Request) (*{{.M.APIAlias}}.Delete{{.Web.R.PluralName}}Response, error) {
...
func (h *Handler) Get{{.Web.R.SingularName}}(ctx context.Context, rq *{{.M.APIAlias}}.Get{{.Web.R.SingularName}}Request) (*{{.M.APIAlias}}.Get{{.Web.R.SingularName}}Response, error) {
	{{- if .Web.WithOTel}}
...
func (h *Handler) List{{.Web.R.SingularName}}(ctx context.Context, rq *{{.M.APIAlias}}.List{{.Web.R.SingularName}}Request) (*{{.M.APIAlias}}.List{{.Web.R.SingularName}}Response, error) {
