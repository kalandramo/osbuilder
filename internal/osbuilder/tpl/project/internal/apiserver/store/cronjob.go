...
// newCronJobStore creates a new cronJobStore instance with the provided store and logger.
func newCronJobStore(s *store) *cronJobStore {
	return &cronJobStore{
		Store: genericstore.NewStore[model.CronJobM](s, storelogger.NewLogger()),
	}
}
